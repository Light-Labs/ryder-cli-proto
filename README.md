...
@lightlabs/ryder-cli-proto/0.0.4 win32-x64 node-v16.17.1
...
* [`ryder-cli-proto multi`](#ryder-cli-proto-multi)
...
* [`ryder-cli-proto test-accept-all`](#ryder-cli-proto-test-accept-all)
* [`ryder-cli-proto test-normal-operation`](#ryder-cli-proto-test-normal-operation)
* [`ryder-cli-proto test-reject-all`](#ryder-cli-proto-test-reject-all)
...
_See code: [src/commands/multi.ts](https://github.com/Light-Labs/ryder-cli-proto/blob/v0.0.4/src/commands/multi.ts)_
...
## `ryder-cli-proto test-accept-all`

Set Ryder device in test mode: accept all.
...
_See code: [src/commands/test-accept-all.ts](https://github.com/Light-Labs/ryder-cli-proto/blob/v0.0.4/src/commands/test-accept-all.ts)_

## `ryder-cli-proto test-normal-operation`

Set Ryder device in test mode: normal operation.
...
_See code: [src/commands/test-normal-operation.ts](https://github.com/Light-Labs/ryder-cli-proto/blob/v0.0.4/src/commands/test-normal-operation.ts)_

## `ryder-cli-proto test-reject-all`

Set Ryder device in test mode: reject all.
...
_See code: [src/commands/test-reject-all.ts](https://github.com/Light-Labs/ryder-cli-proto/blob/v0.0.4/src/commands/test-reject-all.ts)_
